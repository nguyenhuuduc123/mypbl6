              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text(widget.documentSnapshot['price'] + 'đ/đêm', style: TextStyle(
                        color: Colors.black,
                        fontSize: 20,
                        fontWeight: FontWeight.w600,
                        letterSpacing: 0.8
                    ...
                    SizedBox(height: 10,),
                    Row(children: [
                      Text('Nhận phòng: ' + widget.documentSnapshot['checkIn'], style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                      ),),
                      SizedBox(width: 10,),
                      Text('Trả phòng: ' + widget.documentSnapshot['checkOut'], style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                      ),),
                    ...
                    SizedBox(height: 10,),
                    Text('Địa chỉ: '+ widget.documentSnapshot['address'], style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                        letterSpacing: 0.4
                    ...
                    SizedBox(height: 10,),
                    Text('Mô tả: '+widget.documentSnapshot['description'], style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
