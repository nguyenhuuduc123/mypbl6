                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: const Icon(FontAwesomeIcons.caretLeft, color: Colors.white, size: 40,),
                        color: Colors.black,
                        iconSize: 30,
                      ),
                    ],
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(FontAwesomeIcons.locationArrow, size: 25,
                            color: Colors.white,),
                          const SizedBox(width: 5,),
                          Text(widget.documentSnapshot['nameCity'], style: const TextStyle(
                              color: Colors.white,
                              fontSize: 25,
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(widget.documentSnapshot['nameHotel'], style: const TextStyle(
                          color: Colors.black,
                          fontSize: 24,
                          fontWeight: FontWeight.w600,
                          letterSpacing: 0.8,
                      ...
                      Text(widget.documentSnapshot['price'] + 'đ/đêm', style: const TextStyle(
                          color: Colors.black,
                          fontSize: 20,
                          fontWeight: FontWeight.w600,
                          letterSpacing: 0.8
                      ...
                      Row(children: [
                        Text('Nhận phòng: ' + widget.documentSnapshot['checkIn'], style: const TextStyle(
                          color: Colors.black,
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                        ),),
                        const SizedBox(width: 10,),
                        Text('Trả phòng: ' + widget.documentSnapshot['checkOut'], style: const TextStyle(
                          color: Colors.black,
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                        ),),
                      ...
                      const SizedBox(height: 10,),
                      Text('Địa chỉ: '+ widget.documentSnapshot['address'], style: const TextStyle(
                          color: Colors.black,
                          fontSize: 18,
                          fontWeight: FontWeight.w600,
                          letterSpacing: 0.4
                      ...
                      const SizedBox(height: 10,),
                      Text('Mô tả: '+widget.documentSnapshot['description'], style: const TextStyle(
                          color: Colors.black,
                          fontSize: 18,
